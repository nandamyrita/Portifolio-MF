        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center min-h-[80vh]">
          ...
          >
            <div className="space-y-4">
              ...
              >
                Apaixonada por tecnologia e inovação, criando experiências
                digitais únicas com código limpo e design moderno que fazem a
                diferença no mundo digital.
              </motion.p>
              <motion.div
              ...
              >
                ...
                >
                  <a
                    href="#projects"
                    className="group inline-flex items-center justify-center bg-pink-600 hover:from-pink-600 hover:to-rose-600 border-0 text-white px-8 py-6 text-lg rounded-2xl transition-all duration-300 hover:shadow-2xl hover:shadow-pink-500/25 relative overflow-hidden h-14"
                  >
                    <motion.div
