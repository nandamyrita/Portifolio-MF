  ...
  const experiences = [
    {
      ...
      description: 'Lidero equipe de desenvolvimento de aplicações web escaláveis usando React, Node.js e AWS. Responsável por arquitetura de sistemas e mentoria de desenvolvedores juniores.',
      achievements: [
    ...
    },
    {
      ...
      period: '2020 - 2022',
      location: 'São Paulo, SP',
      description: 'Desenvolvi aplicações web completas do zero, trabalhando diretamente com fundadores para transformar ideias em produtos digitais.',
      achievements: [
    ...
    },
    {
      ...
      period: '2019 - 2020',
      location: 'São Paulo, SP',
      description: 'Criei interfaces responsivas e interativas para diversos clientes, focando em experiência do usuário e performance.',
      achievements: [
    ...
    },
    {
      ...
      period: '2018 - 2019',
      location: 'São Paulo, SP',
      description: 'Iniciei minha carreira desenvolvendo websites e aprendendo as melhores práticas de desenvolvimento web.',
      achievements: [
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="absolute left-8 md:left-1/2 transform md:-translate-x-0.5 w-1 bg-gray-700 h-full">
            <motion.div
              className="w-full bg-gradient-to-b from-pink-500 to-purple-500 origin-top"
              ...
              >
                ...
                <motion.div
                  className={`absolute left-8 md:left-1/2 transform md:-translate-x-1/2 w-6 h-6 rounded-full border-4 border-black z-10 ${
                    exp.highlight ? 'bg-pink-500' : 'bg-purple-500'
                  }`}
                ...
                >
                  <div className={`bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur border rounded-2xl p-8 relative overflow-hidden group ${
                    exp.highlight ? 'border-pink-500/40' : 'border-pink-500/20'
                    ...
                    {exp.highlight && (
                      <motion.div
                        className="absolute -top-2 -right-2 bg-gradient-to-r from-pink-500 to-purple-500 px-3 py-1 rounded-lg text-xs text-white font-bold"
                    ...
                    <div className="relative z-10">
                      ...
                      {/* Achievements */}
                      <div className="mb-6">
                        <h4 className="text-pink-400 font-medium mb-3">Principais conquistas:</h4>
                      ...
                      {/* Technologies */}
                      <div>
                        <h4 className="text-pink-400 font-medium mb-3">Tecnologias utilizadas:</h4>
                        <div className="flex flex-wrap gap-2">
                          {exp.tech.map((tech, techIndex) => (
                            <motion.span
                              ...
                              className="px-3 py-1 bg-pink-500/20 text-pink-300 rounded-lg text-sm border border-pink-500/30 hover:border-pink-400/50 hover:bg-pink-500/30 transition-all duration-300"
                            >
                              {tech}
                            </motion.span>
                          ))}
        ...
        >
          <h3 className="text-2xl font-bold text-pink-400 mb-4">Quer saber mais sobre minha experiência?</h3>
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-block bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white px-8 py-4 rounded-xl transition-all duration-300 hover:shadow-2xl hover:shadow-pink-500/25"
          >
            Vamos conversar!
          </motion.a>
        </motion.div>
